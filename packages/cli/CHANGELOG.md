...
- Updated dependencies [25740cc]
  ...
  - @ai-gui/plugin-evidence@0.39.1
  - @ai-gui/plugin-figure@0.39.1
  - @ai-gui/plugin-flashcard@0.39.1
  - @ai-gui/plugin-form@0.39.1
  - @ai-gui/plugin-function@0.39.1
  - @ai-gui/plugin-graph@0.39.1
  - @ai-gui/plugin-gravity@0.39.1
  - @ai-gui/plugin-highlight@0.39.1
  - @ai-gui/plugin-katex@0.39.1
  - @ai-gui/plugin-map@0.39.1
  - @ai-gui/plugin-motion@0.39.1
  - @ai-gui/plugin-optics@0.39.1
  - @ai-gui/plugin-physics@0.39.1
  - @ai-gui/plugin-primitives@0.39.1
  - @ai-gui/plugin-progress@0.39.1
  - @ai-gui/plugin-quote@0.39.1
  - @ai-gui/plugin-resultset@0.39.1
...
- 93c83c0: New package: the `aigui` command line. `aigui prompt` writes the system prompt `buildSystemPrompt` would build, from a JSON config or flags, so a Go, Rust, Python or Java backend can read it from a file instead of receiving it from the browser.

### Patch Changes

- @ai-gui/core@0.39.0
- @ai-gui/plugin-katex@0.39.0
- @ai-gui/plugin-highlight@0.39.0
- @ai-gui/plugin-mermaid@0.39.0
- @ai-gui/plugin-primitives@0.39.0
- @ai-gui/plugin-chart@0.39.0
- @ai-gui/plugin-form@0.39.0
...
- @ai-gui/plugin-function@0.39.0
- @ai-gui/plugin-optics@0.39.0
- @ai-gui/plugin-motion@0.39.0
- @ai-gui/plugin-gravity@0.39.0
- @ai-gui/plugin-graph@0.39.0
- @ai-gui/plugin-quote@0.39.0
- @ai-gui/plugin-resultset@0.39.0
- @ai-gui/plugin-physics@0.39.0
- @ai-gui/plugin-figure@0.39.0
- @ai-gui/plugin-progress@0.39.0
- @ai-gui/plugin-flashcard@0.39.0
- @ai-gui/plugin-map@0.39.0
- @ai-gui/plugin-evidence@0.39.0
